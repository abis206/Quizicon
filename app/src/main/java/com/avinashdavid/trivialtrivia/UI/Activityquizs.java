...
public class Activityquizs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startCardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Activityquizs.this, ActivityQuiz.class);
        ...
        statsCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursorCount<=0){
                    Toast.makeText(Activityquizs.this, R.string.no_stats, Toast.LENGTH_LONG).show();
                } else {
                    Intent intent = new Intent(Activityquizs.this, ActivityStatistics.class);
                    startActivity(intent);
                }
                cursor.close();
            }
        ...
        ((CardView)findViewById(R.id.card_view_instructions)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Activityquizs.this, ActivityInstructions.class);
                startActivity(intent);
            }
        });
        ...
        ((CardView)findViewById(R.id.card_view_acknowledgments)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Activityquizs.this, ActivityAcknowledgments.class);
                startActivity(intent);
            }
        });
    }
